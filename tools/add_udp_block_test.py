#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""تست رگرسیون بلاک UDP در حالت Tor را می‌سازد."""
import io
import os
import sys

DIR = "test/features/sing_box/application"
PATH = os.path.join(DIR, "sing_box_tor_udp_block_test.dart")

CONTENT = r'''import 'package:flutter_test/flutter_test.dart';
...
def main():
    if not os.path.isdir(DIR):
        print("[x] پوشه‌ی تست پیدا نشد: %s" % DIR)
        return 1

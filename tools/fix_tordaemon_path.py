...
path = "android/app/src/main/kotlin/com/example/v2ray_stk/vpn/TorDaemon.kt"

code = """package com.example.v2ray_stk.vpn
...
print("TorDaemon.kt rewritten successfully!")
